...
*/
  ...
  const TEMPLATE = require("lovec/temp/rs/RS_p1DustItem");
...
*/
  ...
  const item0int0dust0p1_sand = extendBase(
    TEMPLATE, "item0int0dust0p1-sand",
    TEMPLATE.build({
  ...
  const item0int0dust0p1_bauxite = extendBase(
    TEMPLATE, "item0int0dust0p1-bauxite",
    TEMPLATE.build({
  ...
  const item0int0dust0p1_rawCoal = extendBase(
    TEMPLATE, "item0int0dust0p1-raw-coal",
    TEMPLATE.build({
  ...
  const item0int0dust0p1_chalcopyrite = extendBase(
    TEMPLATE, "item0int0dust0p1-chalcopyrite",
    TEMPLATE.build({
  ...
  const item0int0dust0p1_malachite = extendBase(
    TEMPLATE, "item0int0dust0p1-malachite",
    TEMPLATE.build({
  ...
  const item0int0dust0p1_hematite = extendBase(
    TEMPLATE, "item0int0dust0p1-hematite",
    TEMPLATE.build({
  ...
  const item0int0dust0p1_limonite = extendBase(
    TEMPLATE, "item0int0dust0p1-limonite",
    TEMPLATE.build({
  ...
  const item0int0dust0p1_magnetite = extendBase(
    TEMPLATE, "item0int0dust0p1-magnetite",
    TEMPLATE.build({
  ...
  const item0int0dust0p1_galena = extendBase(
    TEMPLATE, "item0int0dust0p1-galena",
    TEMPLATE.build({
