...
*/
  ...
  const item0int0conc_chromite = extendBase(
    TEMPLATE, "item0int0conc-chromite",
    TEMPLATE.build({
  ...
  const item0int0conc_fluorite = extendBase(
    TEMPLATE, "item0int0conc-fluorite",
    TEMPLATE.build({
  ...
  const item0int0conc_pyrite = extendBase(
    TEMPLATE, "item0int0conc-pyrite",
    TEMPLATE.build({
  ...
  const item0int0conc_pyrrhotite = extendBase(
    TEMPLATE, "item0int0conc-pyrrhotite",
    TEMPLATE.build({
  ...
  const item0int0conc_psilomelane = extendBase(
    TEMPLATE, "item0int0conc-psilomelane",
    TEMPLATE.build({
  ...
  const item0int0conc_pyrolusite = extendBase(
    TEMPLATE, "item0int0conc-pyrolusite",
    TEMPLATE.build({
  ...
  const item0int0conc_nickelLaterite = extendBase(
    TEMPLATE, "item0int0conc-nickel-laterite",
    TEMPLATE.build({
  ...
  const item0int0conc_pentlandite = extendBase(
    TEMPLATE, "item0int0conc-pentlandite",
    TEMPLATE.build({
  ...
  const item0int0conc_cassiterite = extendBase(
    TEMPLATE, "item0int0conc-cassiterite",
    TEMPLATE.build({
  ...
  const item0int0conc_ilmenite = extendBase(
    TEMPLATE, "item0int0conc-ilmenite",
    TEMPLATE.build({
  ...
  const item0int0conc_rutile = extendBase(
    TEMPLATE, "item0int0conc-rutile",
    TEMPLATE.build({
  ...
  const item0int0conc_scheelite = extendBase(
    TEMPLATE, "item0int0conc-scheelite",
    TEMPLATE.build({
  ...
  const item0int0conc_wolframite = extendBase(
    TEMPLATE, "item0int0conc-wolframite",
    TEMPLATE.build({
  ...
  const item0int0conc_sphalerite = extendBase(
    TEMPLATE, "item0int0conc-sphalerite",
    TEMPLATE.build({
