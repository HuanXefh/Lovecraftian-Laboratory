...
*/
  ...
  const TEMPLATE = require("lovec/temp/rs/RS_dustItem");
...
*/
  ...
  const item0int0dust_sand = extendBase(
    TEMPLATE, "item0int0dust-sand",
    TEMPLATE.build({
  ...
  const item0int0dust_bauxite = extendBase(
    TEMPLATE, "item0int0dust-bauxite",
    TEMPLATE.build({
  ...
  const item0int0dust_rawCoal = extendBase(
    TEMPLATE, "item0int0dust-raw-coal",
    TEMPLATE.build({
  ...
  const item0int0dust_azurite = extendBase(
    TEMPLATE, "item0int0dust-azurite",
    TEMPLATE.build({
  ...
  const item0int0dust_chalcopyrite = extendBase(
    TEMPLATE, "item0int0dust-chalcopyrite",
    TEMPLATE.build({
  ...
  const item0int0dust_malachite = extendBase(
    TEMPLATE, "item0int0dust-malachite",
    TEMPLATE.build({
  ...
  const item0int0dust_hematite = extendBase(
    TEMPLATE, "item0int0dust-hematite",
    TEMPLATE.build({
  ...
  const item0int0dust_limonite = extendBase(
    TEMPLATE, "item0int0dust-limonite",
    TEMPLATE.build({
  ...
  const item0int0dust_magnetite = extendBase(
    TEMPLATE, "item0int0dust-magnetite",
    TEMPLATE.build({
  ...
  const item0int0dust_psilomelane = extendBase(
    TEMPLATE, "item0int0dust-psilomelane",
    TEMPLATE.build({
  ...
  const item0int0dust_nickelLaterite = extendBase(
    TEMPLATE, "item0int0dust-nickel-laterite",
    TEMPLATE.build({
  ...
  const item0int0dust_cassiterite = extendBase(
  ...
  const item0int0dust_rockEvaporite = extendBase(
    TEMPLATE, "item0int0dust-rock-evaporite",
    TEMPLATE.build({
  ...
  const item0int0dust_rockHypabyssal = extendBase(
    TEMPLATE, "item0int0dust-rock-hypabyssal",
    TEMPLATE.build({
  ...
  const item0int0dust_rockLava = extendBase(
    TEMPLATE, "item0int0dust-rock-lava",
    TEMPLATE.build({
  ...
  const item0int0dust_rockMetamorphic = extendBase(
    TEMPLATE, "item0int0dust-rock-metamorphic",
    TEMPLATE.build({
  ...
  const item0int0dust_rockPlutonic = extendBase(
    TEMPLATE, "item0int0dust-rock-plutonic",
    TEMPLATE.build({
  ...
  const item0int0dust_rockBiologicalSedimentary = extendBase(
    TEMPLATE, "item0int0dust-rock-biological-sedimentary",
    TEMPLATE.build({
  ...
  const item0int0dust_rockClasticSedimentary = extendBase(
    TEMPLATE, "item0int0dust-rock-clastic-sedimentary",
    TEMPLATE.build({
